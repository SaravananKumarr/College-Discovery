  ...
  return (
    <div style={{
      ...
      <div className="card" style={{ width: '100%', maxWidth: 420, padding: 40 }}>
        <h1 style={{ fontFamily: 'Sora, sans-serif', fontSize: 28, fontWeight: 800, marginBottom: 8, color: '#0f172a' }}>Welcome back</h1>
        <p style={{ color: '#64748b', marginBottom: 28, fontSize: 15 }}>Sign in to your CollegeScope account</p>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          <button onClick={submit} disabled={loading || !form.email || !form.password} className="btn-primary" style={{ width: '100%', padding: '12px', fontSize: 15, marginTop: 8 }}>
        ...
        <p style={{ textAlign: 'center', marginTop: 24, color: '#64748b', fontSize: 14 }}>
          ...
          <Link href="/register" style={{ color: '#2563eb', fontWeight: 600, textDecoration: 'none' }}>Sign up</Link>
        </p>
      </div>
    </div>
  )
